...
#
# Script generated by Vivado on Tue Nov 28 15:46:29 -0500 2023
...
#
# Usage        : block_map.sh
#                block_map.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_map.sh [-reset_run]
#                block_map.sh [-reset_log]
#                block_map.sh [-help]
#
...
#                script (type 'block_map.sh -help' for more information).
#
...
# script info
echo -e "block_map.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_map.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.block_map xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.block_map -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log block_map_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: block_map.sh [-step]\n\
Usage: block_map.sh [-lib_map_path]\n\
Usage: block_map.sh [-reset_run]\n\
Usage: block_map.sh [-reset_log]\n\
Usage: block_map.sh [-keep_index]\n\
