...
#
# Script generated by Vivado on Tue Nov 28 15:48:52 -0500 2023
...
#
# Usage        : bomb_dm.sh
#                bomb_dm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bomb_dm.sh [-reset_run]
#                bomb_dm.sh [-reset_log]
#                bomb_dm.sh [-help]
#
...
# script info
echo -e "bomb_dm.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bomb_dm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bomb_dm xil_defaultlib.bomb_dm xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bomb_dm.wdb xsim.dir libdpi.so)
...
Usage: bomb_dm.sh [-step]\n\
Usage: bomb_dm.sh [-lib_map_path]\n\
Usage: bomb_dm.sh [-reset_run]\n\
Usage: bomb_dm.sh [-reset_log]\n\
Usage: bomb_dm.sh [-keep_index]\n\
