...
#
# Script generated by Vivado on Mon Nov 27 17:56:10 -0500 2023
...
#
# Usage        : pillar_dm.sh
#                pillar_dm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pillar_dm.sh [-reset_run]
#                pillar_dm.sh [-reset_log]
#                pillar_dm.sh [-help]
#
...
#                script (type 'pillar_dm.sh -help' for more information).
#
...
# script info
echo -e "pillar_dm.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pillar_dm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pillar_dm xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pillar_dm -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pillar_dm_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: pillar_dm.sh [-step]\n\
Usage: pillar_dm.sh [-lib_map_path]\n\
Usage: pillar_dm.sh [-reset_run]\n\
Usage: pillar_dm.sh [-reset_log]\n\
Usage: pillar_dm.sh [-keep_index]\n\
